...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-radius:var(--radius-4xl)] [--cell-size:--spacing(9)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        caption_label: cn(
          "font-semibold select-none text-foreground",
          captionLayout === "label"
            ? "text-base"
        ...
        today: cn(
          "rounded-(--cell-radius) bg-accent text-accent-foreground data-[selected=true]:rounded-(--cell-radius)",
